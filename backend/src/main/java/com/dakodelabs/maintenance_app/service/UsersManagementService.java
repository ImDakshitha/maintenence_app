...
public class UsersManagementService {
    ...
    public ReqRes login(ReqRes loginRequest){
        ...
        try {
            authenticationManager
                    .authenticate(new UsernamePasswordAuthenticationToken(loginRequest.getUniversityId(),
                            loginRequest.getPassword()));
            var user = usersRepo.findByUniversityId(loginRequest.getUniversityId()).orElseThrow();
    ...
    public ReqRes refreshToken(ReqRes refreshTokenReqiest){
        ReqRes response = new ReqRes();
        try{
            String ouruniversityId = jwtUtils.extractUsername(refreshTokenReqiest.getToken());
            OurUsers users = usersRepo.findByUniversityId(ouruniversityId).orElseThrow();
    ...
    public ReqRes getMyInfo(String email){
        ReqRes reqRes = new ReqRes();
        try {
            Optional<OurUsers> userOptional = usersRepo.findByUniversityId(email);
            if (userOptional.isPresent()) {
